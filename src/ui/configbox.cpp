	...
	: wxDialog(parent, id, _("Configure"), wxDefaultPosition, wxDefaultSize, wxCAPTION | wxCLOSE_BOX)
{
	...
	bszr = new wxStaticBoxSizer(new wxStaticBox(this, wxID_ANY, _("Data Cache")), wxVERTICAL);
	szrH = new wxBoxSizer(wxHORIZONTAL);
	szrH->Add(new wxStaticText(this, wxID_ANY, _("Limit size")), flags);
	spnCacheLimit = new wxSpinCtrl(this, IDC_SPIN_CACHE_LIMIT);
	spnCacheLimit->SetRange(10, 10000);
	spnCacheLimit->SetValue(ini->GetCacheLimitSize());
	szrH->Add(spnCacheLimit, flags);
	szrH->Add(new wxStaticText(this, wxID_ANY, _("MB")), flags);

	szrH->AddSpacer(16);

	szrH->Add(new wxStaticText(this, wxID_ANY, _("Shrink size")), flags);
	spnCacheShrink = new wxSpinCtrl(this, IDC_SPIN_CACHE_SHRINK);
