...
#if 0
DiskBasicDirItemHU68K::DiskBasicDirItemHU68K(DiskBasic *basic, int n_block_num, int n_position, wxUint8 *n_data)
	: DiskBasicDirItemMSDOS(basic, n_block_num, n_position, n_data)
{
}
DiskBasicDirItemHU68K::DiskBasicDirItemHU68K(DiskBasic *basic, int n_num, const DiskBasicGroupItem *n_gitem, int n_block_num, int n_position, wxUint8 *n_data, const int *n_next, bool &n_unuse)
...
void DiskBasicDirItemHU68K::SetDataPtr(int n_num, const DiskBasicGroupItem *n_gitem, int n_block_num, int n_position, wxUint8 *n_data, const int *n_next)
{
	DiskBasicDirItemMSDOS::SetDataPtr(n_num, n_gitem, n_block_num, n_position, n_data, n_next);
}
#endif

DiskBasicDirItemHU68K::DiskBasicDirItemHU68K(DiskBasic *basic, int n_block_num, int n_position)
	: DiskBasicDirItemMSDOS(basic, n_block_num, n_position)
{
}
DiskBasicDirItemHU68K::DiskBasicDirItemHU68K(DiskBasic *basic, int n_num, const DiskBasicGroupItem *n_gitem, int n_block_num, int n_position, const int *n_next, bool &n_unuse)
...
/// @param [in]  n_position   セクタ内のディレクトリエントリの位置
/// @param [out] n_next       次のセクタ
void DiskBasicDirItemHU68K::SetDataPtr(int n_num, const DiskBasicGroupItem *n_gitem, int n_block_num, int n_position, const int *n_next)
{
	DiskBasicDirItemMSDOS::SetDataPtr(n_num, n_gitem, n_block_num, n_position, n_next);
}
