...
const char *gDiskBasicErrorMsgs[] = {
	...
	//	ERRV2_VERIFY_FILE  v:2
	wxTRANSLATE("Verify error. group:%d sector:%d"),
	//	ERRV_MISMATCH_FILESIZE  v:2
	wxTRANSLATE("Mismatch file size. origin:%d now:%d"),
	//	ERRV2_NO_SECTOR  v:2
	wxTRANSLATE("No sector exists. group:%d sector:%d"),
	//	ERRV3_INVALID_SECTOR  v:3
	wxTRANSLATE("Invalid sector. group:%d sector:%d sector_size:%d"),
