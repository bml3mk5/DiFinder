...
//	DiskBasicDirItemMSDOS(DiskBasic *basic, int n_block_num, int n_position, wxUint8 *n_data);
//	DiskBasicDirItemMSDOS(DiskBasic *basic, int n_num, const DiskBasicGroupItem *n_gitem, int n_block_num, int n_position, wxUint8 *n_data, const int *n_next, bool &n_unuse);
...
//	virtual void	SetDataPtr(int n_num, const DiskBasicGroupItem *n_gitem, int n_block_num, int n_position, wxUint8 *n_data, const int *n_next = NULL);
	...
	virtual int		GetPosition() const { return m_data.GetPosition(); }
...
//	DiskBasicDirItemVFAT(DiskBasic *basic, int n_block_num, int n_position, wxUint8 *n_data);
//	DiskBasicDirItemVFAT(DiskBasic *basic, int n_num, const DiskBasicGroupItem *n_gitem, int n_block_num, int n_position, wxUint8 *n_data, const int *n_next, bool &n_unuse);
	DiskBasicDirItemVFAT(DiskBasic *basic, int n_block_num, int n_position);
	DiskBasicDirItemVFAT(DiskBasic *basic, int n_num, const DiskBasicGroupItem *n_gitem, int n_block_num, int n_position, const int *n_next, bool &n_unuse);
