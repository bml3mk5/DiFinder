...
******************************************************************************
  ...
  (3)OS(ファイルシステム)の情報
   ...
   ■希望のOSが表示されない場合
   「変更」ボタンを押して希望のOSを選択しOKを押してください。

   ■希望のOSが一覧にない場合
     (2)のディスクイメージを変更してみてください。

   ■OSが解析エラーになりファイル一覧が表示されない場合
...
○ ディスクイメージ一覧(画面(1))のポップアップメニュー説明
  ...
  「BASIC情報」............ 選択しているディスクのOS(ファイルシステム)情報を
                            表示します。
                            一部OSでは、ラベル名の編集ができます。
...
○ BASIC変更ダイアログについての説明
  ...
  OS(ファイルシステム)を変更してOKボタンを押すと再解析を行います。
